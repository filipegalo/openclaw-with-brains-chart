...
![AppVersion: 2026.3.23](https://img.shields.io/badge/AppVersion-2026.3.23-informational?style=flat-square)
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/openclaw/openclaw","tag":"2026.3.23"}` | ------------------------------------------------------------------------- |
| image.pullPolicy | string | `"IfNotPresent"` | Image pull policy. |
| image.repository | string | `"ghcr.io/openclaw/openclaw"` | OpenClaw container image repository. |
| image.tag | string | `"2026.3.23"` | OpenClaw container image tag. |
