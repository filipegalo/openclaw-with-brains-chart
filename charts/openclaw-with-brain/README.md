...
![AppVersion: 2026.5.22](https://img.shields.io/badge/AppVersion-2026.5.22-informational?style=flat-square)
![Version: 0.1.58](https://img.shields.io/badge/Version-0.1.58-informational?style=flat-square)
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/openclaw/openclaw","tag":"2026.5.22"}` | ------------------------------------------------------------------------- |
| image.pullPolicy | string | `"IfNotPresent"` | Image pull policy. |
| image.repository | string | `"ghcr.io/openclaw/openclaw"` | OpenClaw container image repository. |
| image.tag | string | `"2026.5.22"` | OpenClaw container image tag. |
