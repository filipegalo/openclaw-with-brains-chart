...
![AppVersion: 2026.4.24](https://img.shields.io/badge/AppVersion-2026.4.24-informational?style=flat-square)
![Version: 0.1.45](https://img.shields.io/badge/Version-0.1.45-informational?style=flat-square)
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/openclaw/openclaw","tag":"2026.4.24"}` | ------------------------------------------------------------------------- |
| image.pullPolicy | string | `"IfNotPresent"` | Image pull policy. |
| image.repository | string | `"ghcr.io/openclaw/openclaw"` | OpenClaw container image repository. |
| image.tag | string | `"2026.4.24"` | OpenClaw container image tag. |
